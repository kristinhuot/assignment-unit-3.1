...
let favoriteFoods = ['pretzels', 'popcorn', 'fruit', 'pizza', 'peanut butter toast with bananas' ];
console.log( 'Some of my current favorite foods are:', favoriteFoods );
...
console.log( 'Number of current food favs:', numberOfFoods);
...
console.log( 'This is the animal array', animalArray );
...
let dessert = 'raspberry chip ice cream'

favoriteFoods.push(dessert);
console.log('Added dessert to my fav foods', favoriteFoods);
...
let entree = 'gyros with tzatziki';
favoriteFoods.unshift(entree);
console.log('Added an entree I enjoy to the beginning', favoriteFoods);
...
console.log('Removed the first color from the beginning of the array - ', firstColor);
console.log('The color array is now', colors);
